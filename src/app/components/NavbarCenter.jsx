...
export default function NavbarCenter({ hexcodleNumber, miniNumber }) {
  ...
  if (pathname === "/archive") {
    return (
      <Link href={"/"}>
        <p className="roboto font-semibold tracking-tight text-2xl hover:text-lime-500 active:text-lime-700">
          Hexcodle Archive
        </p>
      </Link>
    );
    ...
    return (
      <>
        ...
        <Link
          ...
          className="flex items-center justify-center hover:text-lime-500 active:text-lime-700"
