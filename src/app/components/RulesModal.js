...
export default function RulesModal({ isOpen, setIsOpen }) {
    return (
        ...
        <p>
            ...
            displayed on screen in the <i>target</i> box. After each guess, the colour of the hex code
            you entered will be displayed in the <i>your guess</i> box.
        </p>
        <p>
            There will be symbols that pop up in the <i>guesses</i> section that indicate the closeness
            of your guess. Use these to gauge your next guess! Here is what each symbol means:
        </p>
        <p>
            ✅ You got it! <br></br>
            🔼 Guess higher (only off by 1 or 2) <br></br>
            🔽 Guess lower (only off by 1 or 2) <br></br>
